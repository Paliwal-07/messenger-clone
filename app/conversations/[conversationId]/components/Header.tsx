...
const Header:React.FC<HeaderProps> = ({conversation}) => {
  ...
  const statusText = useMemo(() => {
    if (conversation.isGroup) {
      return `${conversation.users.length} members online`;
    }
  ...
  return (
    <>
      ...
      <div className="bg-white w-full flex border-b-[1px] sm:px-4 py-3 p-4 lg:px-6 justify-between items-center shadow-sm">
